...
class REDNetDetSkip_upsample(nn.Module):
    def __init__(self, block, layers):
        ...
        self.out_det = nn.Conv2d(32, 7, kernel_size=1, stride=1, bias=False)
...
def CreateNet(opt):
    net = REDNetDetSkip_upsample(Residual, [3, 8, 36, 3])
